...
rectangle_t intersection(rectangle_t r1, rectangle_t r2) {
  // WRITE THIS FUNCTION
  // canonicalize r1 and r2
  r1 = canonicalize(r1);
  r2 = canonicalize(r2);
  rectangle_t r3;  //declare a intermediate rectangle
  //decide r3.x
  if (r1.x <= r2.x) {
    r3.x = r2.x;
  }
  ...
  if ((r1.x + r1.width) <= (r2.x + r2.width)) {
    r3.width = (r1.x + r1.width) - r3.x;
  }
  else {
    r3.width = (r2.x + r2.width) - r3.x;
  }
  //decide r3.y
  if (r1.y <= r2.y) {
    r3.y = r2.y;
  ...
  if ((r1.y + r1.height) <= (r2.y + r2.height)) {
    r3.height = (r1.y + r1.height) - r3.y;
  }
  else {
    r3.height = (r2.y + r2.height) - r3.y;
  }
  //Let r1 be r3 and return it
