...
void testList(void) {
  ...
  d = (IL.remove(10) == 0 && IL.getSize() == 4 && IL[0] == 5 && IL[1] == 3 && IL[2] == 2 &&
       IL[3] == 7);
  decide(d);
  //case 2: the first element
  d = (IL.remove(5) == 1 && IL.getSize() == 3 && IL[0] == 3 && IL[1] == 2 && IL[2] == 7);
  decide(d);
  //case 3: the middle element
  d = (IL.remove(2) == 1 && IL.getSize() == 2 && IL[0] == 3 && IL[1] == 7);
  decide(d);
  //case 4: the last element
  d = (IL.remove(7) == 1 && IL.getSize() == 1 && IL[0] == 3);
  decide(d);
  //case 5: will be empty
  d = (IL.remove(3) == 1 && IL.getSize() == 0 && IL.head == NULL && IL.tail == NULL);
  decide(d);
